...
\begin{groupplot}[
   ...
   %xlabel= { $\lambda$},
    ...
    \node (mypic) at (axis cs:2e3,4.5e-4) {\includegraphics[scale = .095]{ball-4-norm-squares-p2q2-lvl4-mu-2-20-k-0-0.png}};
    \node[draw,circle,ultra thick,lightgray] (W1) at (axis cs:3.2e5,7.9e-4) {};
    ...
    \node (mypicc) at (axis cs:2e3,4.5e-4) {\includegraphics[scale = .095]{ball-4-norm-squares-p2q2-lvl4-mu-2-2-k-0-0.png}};
    ...
    legend style = { column sep = 10pt, legend columns = 5, legend to name = grouplegend,},
     ...
     \node (mypiccc) at (axis cs:2e3,4.5e-4) {\includegraphics[scale = .095]{ball-4-norm-squares-p2q2-lvl4-mu-20-2-k-0-0.png}};
    \node[draw,circle,ultra thick,lightgray] (K1) at (axis cs:3.2e5,3.7e-4) {};
