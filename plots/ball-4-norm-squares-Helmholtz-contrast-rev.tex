...
\begin{groupplot}[
   ...
   \draw[] (axis cs:2e5,1.5e-4)  node[rotate=-50, minimum size=0.1mm]{ \scriptsize $ \mathcal{O}(h^{4}) $   };
    ...
    %\node (mypic) at (12.95,0.95) {\includegraphics[scale = .1025]{ball-4-norm-squares-p3-q3-lvl5-abserr-mu2-20.png}};
    ...
    %\node (mypicb) at (12.95,0.95) {\includegraphics[scale = .1025]{ball-4-norm-squares-p3-q3-lvl5-abserr-mu20-2.png}};
